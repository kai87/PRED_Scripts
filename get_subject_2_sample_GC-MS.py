...
out_file_note = open(path + "/Outputs/GC-MS_note.txt", "w")
...
out_file = open(path + "/Outputs/GC-MS_sub2sample_kai.txt", "w")
...
for line in in_file:
	...
	if sample_id in sample2subject_mapping:
		...
		if subject_id in subjects_for_uploading:		
			outline = "May2014_UBIO" + "\t" + "\t" + subject_id + "\t" + sample_id + "\t" + "GPL570" + "\t" + "GC-MS" + "\t" + "Breathomics" + "\t" + "\t" + "OMICS_DATA+ATTR1+Baseline_Visit+TISSUETYPE+PLATFORM" + "\n"
			out_file.write(outline)
