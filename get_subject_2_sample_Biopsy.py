...
out_file_note = open(path + "./Outputs/Biopsy_note.txt", "w")
...
in_raw_file = open(path + "./Raw_data/UBIOPRED.Biopsy.PassQC.RMA2.txt", "r")
...
in_file = open(path + "./Raw_data/UBIOPRED.Biopsy.PassQC.Design.txt", "r")
out_file = open(path + "./Outputs/Biopsy_sub2sample_kai.txt", "w")
